...
from gnns.myModel.model_new import MyModel
...
def train(args):
    ...
    model = MyModel(
        ...
        args.num_hidden, data.num_classes, g.canonical_etypes, args.num_layers, predict_ntype, attn_drop=args.dropout, tem=args.tau
    ).to(args.device)
...
def main():
    ...
    parser.add_argument('--fuse-way', choices=['drop-edge', 'attr-mask'], default='drop-edge', help='扰动方式')
