...
class MyModel(nn.Module):
    ...
    def forward(self, blocks, feat):
        ...
        # remove target nodes label emb
        # tp_emb = feat[self.predict_ntype][:predict_nodes_num]
        # tp_emb[:, -self.out_dim:] = torch.zeros(predict_nodes_num, self.out_dim).cuda()
        # feat[self.predict_ntype][:predict_nodes_num] = tp_emb
